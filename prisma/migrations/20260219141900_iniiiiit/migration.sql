-- AlterTable
ALTER TABLE "Course" ALTER COLUMN "update_at" DROP DEFAULT;

-- AlterTable
ALTER TABLE "Student" ALTER COLUMN "update_at" DROP DEFAULT;

-- AlterTable
ALTER TABLE "Teacher" ALTER COLUMN "update_at" DROP DEFAULT;
...
-- CreateTable
CREATE TABLE "HomeworkAnswerTeacher" (
    "id" SERIAL NOT NULL,
    "homework_id" INTEGER NOT NULL,
    "teacher_id" INTEGER NOT NULL,
    "grade" INTEGER,
    ...
    CONSTRAINT "HomeworkAnswerTeacher_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Attendance" ADD CONSTRAINT "Attendance_student_id_fkey" FOREIGN KEY ("student_id") REFERENCES "Student"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "HomeworkAnswerTeacher" ADD CONSTRAINT "HomeworkAnswerTeacher_homework_id_fkey" FOREIGN KEY ("homework_id") REFERENCES "Homework"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HomeworkAnswerTeacher" ADD CONSTRAINT "HomeworkAnswerTeacher_teacher_id_fkey" FOREIGN KEY ("teacher_id") REFERENCES "Teacher"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
